...
net.add_layer(activations.LeakeyReLU(negative_slope=0.01))
...
# optimizer
optimizer = optimizers.Momentum(learning_rate=learning_rate, momentum=0.9, lr_decay=lr_decay, params=net.params, grads=net.grads)
